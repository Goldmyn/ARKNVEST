      ...
      <div class="relative md:ml-64 bg-blueGray-50">
        ...
        <div class="px-4 bg-black md:px-10 mx-auto w-full -m-24">
          ...
          <div class="w-full  xl:w-8/12 mb-12 xl:mb-0 px-4">
              <div
                class="relative  flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-l bg-black"
              >
                <div class="rounded-t mb-0 px-4 py-3 bg-transparent">
                  <div class="flex flex-wrap items-center">
                    <div class="relative w-full max-w-full flex-grow flex-1">
                      ...
                      <h2 class="text-black text-lg p-2 font-semibold bg-blue-gradient rounded-lg text-center"  id="ad2">
                ...
                <div class="rounded-t mb-0 px-4 py-3 bg-transparent">
                  <div class="flex flex-wrap items-center">
                    <div class="relative w-full max-w-full flex-grow flex-1">
                      ...
                      <h2 class="text-lg font-semibold bg-blue-gradient p-2 text-center rounded-lg text-black w-full" id="ad1" >
                      0xD6Af6251a93Be24bea298E213703BAEB001d3186
                      </h2>
