      ...
      <div class="relative md:ml-64 bg-blueGray-50">
        ...
        <div class="relative bg-gray-300 md:pt-32 pb-32 pt-12">
          <div class="px-4 md:px-10 mx-auto w-full">
            <div class="text-center font-bold text-3xl text-gold-gradient">
              <!-- Card stats -->DEPOSIT <span class="text-gradient">USDT</span> <span class="text-gradient-c font-bold text-lg">OR</span> <span class="text-gold-gradient">BUSD</span>
            </div>
          </div>
        </div>
        <div class="px-4 md:px-10 mx-auto w-full -m-24">
          ...
          <div class="w-full xl:w-8/12 mb-12 xl:mb-0 px-4">
              <div
                class="relative bg-black flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-black"
              >
                <div class="rounded-t mb-0 px-4 py-3 bg-transparent">
                  <div class="flex flex-wrap items-center">
                    <div class="relative w-full max-w-full flex-grow flex-1">
                      ...
                      >
                        Copy the address below to deposit USDT (ERC20).
                      </h6>
                      <h2 class="text-white text-xl p-2 font-semibold bg-blue-gradient rounded-lg text-center"  id="ad2">
                      0xD6Af6251a93Be24bea298E213703BAEB001d3186
                      </h2>
                    </div>
                  </div>
                </div>
                <div class="p-4 flex-auto">
                  <!-- Chart -->
                  <div class="relative" >
                  <img src="./assets/img/ERC20-USDT.png" 
                          class="md:h-[750px]"  
                    />

                    <div class=" flex-auto bg-blue-gradient  mt-3 rounded text-center items-center justify-center ">
                        <input type="submit" onclick="myFunction('#ad1')"
                                class="font-bold text-gold-gradient  p-3 focus:outline-none cursor-pointer"
                                value="COPY USDT ADDRESS"
                        />
              ...
              >
                <div class="rounded-t mb-0 px-4 py-3 bg-transparent">
                  <div class="flex flex-wrap items-center">
                    <div class="relative w-full max-w-full flex-grow flex-1">
                      <h6
                        class="uppercase text-center text-blueGray-100 mb-1 text-xs font-semibold"
                      >
                        Copy the address below to deposit  BUSD (BEP20).
                      </h6>
                      <h2 class="text-xl font-semibold bg-gold-gradient p-2 text-center rounded-lg text-black w-full" id="ad1" >
                      0xD6Af6251a93Be24bea298E213703BAEB001d3186
                      </h2>
                ...
                <div class="p-4 flex-auto">
                  <!-- Chart -->
                  <div class="relative" >
                    <img src="./assets/img/BEP20-BUSD.png" 
                          class="md:h-[750px]"  
                    />

                    <div class=" flex-auto bg-blue-gradient  mt-3 rounded text-center items-center justify-center">
                        <input  
                                onclick="myFunction('#ad1')"
                                type="submit"
                                value="COPY BUSD ADDRESS"
                                class="font-bold text-gold-gradient  p-3 focus:outline-none cursor-pointer"
                        />
