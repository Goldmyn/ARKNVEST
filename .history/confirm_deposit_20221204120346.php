                ...
                <div class="p-4 flex-auto">
                  ...
                  <div class="relative" >
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
                        ...
                        <div class="relative w- mb-3 text-center ">
                            <input type="submit" class="bg-blue-gradient cursor-pointer text-white active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full" value="NEXT">
                        </div>
                    </form>
