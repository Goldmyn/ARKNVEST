...
<body>
<body class="container text-gray-800 antialiased">
    <nav
    ...
    <main>
      <section class="relative w-full h-full">
        <div
          ...
          style="background-image: url(./assets/img/bannere.jpg); background-size: 100%; background: -cover; background-repeat: repeat;"
        ></div>
        <div class="container mx-auto px-4 h-full">
          <div class="flex content-center items-center justify-center h-full">
            <div class="w-full lg:w-4/12 px-4">
              <div
                class="relative mt-6 flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-black-gradient border-0"
              >
                <div class="rounded-t mb-0 px-6 py-6">
                  <div class="text-center mb-3">
                    <h6 class="text-gray-400 uppercase text-2xl font-semibold">
                      Sign Up
                    </h6>
                  </div>
                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                  ...
                  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <p class="text-black font-bold uppercase mt-3 bg-blue-gradient rounded-lg mr-3 ml-3 p-2"><a href="login.php">Login now</a></p>
