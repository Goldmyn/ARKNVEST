                ...
                <div class="p-4 flex-auto">
                  ...
                  <div class="relative" >
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
                        ...
                        <div class="relative w-full mb-3">
                          <label class="block uppercase text-white text-center text-xs font-bold mb-2" for="grid-password">SELECT NETWORK ADDRESS</label>
                          <select id="country" name="country" class="form-select">
                            <option value="">SELECT NETWORK</option>
                            <option value="naija">ERC20</option>
                            <option value="usa">BEP20</option>
                            <option value="china">TRC</option>
                          </select>
                        </div>
                        <div class="relative w-full mb-3">
