...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        $username_err = "Please enter address network.";     
    } else{
                  ...
                  <div class="relative" >
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
                        ...
                        <div class="relative w-full mb-3">
                            ...
                            <input type="text" name="network" class="border-0 px-2 py-2 placeholder-gray-400 text-gray-700 bg-white rounded text-2xl font-bold shadow focus:outline-none focus:ring w-full <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>">
