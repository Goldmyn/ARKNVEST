                      ...
                      <div class="flex-auto p-4">
                        ...
                        <?php
                          ...
                          if(isset($_SESSION['portfolio']) && $_SESSION['portfolio'] > 100){
                              echo '<button class="p-3 bg-blue-gradient font-bold text-lg rounded-lg uppercase">Trading Activated</button>';
                          } else {
                              echo '<button class="text-red-500">Inactive Trading Account</button>';
