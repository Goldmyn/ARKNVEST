...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($network_err)   && empty($amount_err) && empty($address_err) && empty($confirm_address_err)){
        ...
        $sql = "INSERT INTO deposit (username, network, amount, address) VALUES (?, ?, ?, ?)";
        ...
        <div class="relative bg-gray-300 md:pt-32 pb-32 pt-12">
          <div class="px-4 md:px-10 mx-auto w-full">
            <div class="text-center font-bold text-2xl">
              <!-- Card stats --> <span class="text-black"> DEPOSIT INTO TRADING ACCOUNT </span>
              <p class="text-white text-xl p-2 font-semibold text-center">
                  Provide One Wallet Address For Deposit And Withdrawal.
              </p>
              <p>
                ERC20 BEP20 TRC20
              </p>
                  ...
                  <div class="relative" >
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
                        ...
                        <div class="relative w-full mb-3">
                          ...
                          <select id="country" name="network" class="border-0 px-2 py-2 placeholder-gray-400 text-gray-700 bg-white rounded text-2xl font-bold shadow focus:outline-none focus:ring w-full">
                            <option value="disabled selec">SELECT NETWORK</option>
                        ...
                        <div class="relative w-full mb-3">
                            ...
                            for="grid-password">
                            ENTER  ADDRESS NETWORK <span >e.g ERC20 - BEP20</span> </label>

                            <input type="text" name="network" class="border-0 px-2 py-2 placeholder-gray-400 text-gray-700 bg-white rounded text-2xl font-bold shadow focus:outline-none focus:ring w-full <?php echo (!empty($network_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>">
                            <span class="invalid-feedback text-gold-gradient font-semibold"><?php echo $network_err; ?></span>
                        </div>
                        <div class="relative w-full mb-3">
                            <label class="block  text-white text-center text-xs font-bold mb-2"
