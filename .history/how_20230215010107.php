...
// Check if the form has been submitted and the balance is greater than 100
if (isset($_POST['activate']) && $_SESSION['balance'] > 100) {
  ...
  // If the form has not been submitted or the balance is less than or equal to 100, set the button text to "Inactive"
  $button_text = "Inactive";
}
?>
