    ...
    <div id="root">
      ...
      >
        ...
        >
          ...
          <div
            class="md:flex bg-black md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center  flex-1 rounded hidden"
        ...
        <div class="relative bg-gray-300 md:pt-32 pb-32 pt-12">
          <div class="px-4 md:px-10 mx-auto w-full">
            <div class="text-center font-bold text-black text-3xl">
              <!-- Card stats -->DEPOSIT <br/> USDT<span class="text-gradient-b"> or </span>USDC 
            </div>
          </div>
        </div>
                ...
                <div class="rounded-t mb-0 px-4 py-3 bg-transparent">
                  <div class="flex flex-wrap items-center">
                    <div class="relative w-full max-w-full flex-grow flex-1">
                      ...
                      <h2 class="text-blue-600 text-lg p-2 font-semibold bg-black-gradient  text-center"  id="ad2">
                  ...
                  <img src="./assets/img/ERC20-USDT.png" 
                    ...
                    <div class=" flex-auto bg-blue-gradient  mt-3 rounded text-center items-center justify-center ">
                        <input type="submit" onclick="myFunction('#ad1')"
                                class="font-bold text-black bg-transparent m-2 rounded-lg p-3 focus:outline-none cursor-pointer"
                                value="CLICK TO COPY"
                        />
                ...
                <div class="rounded-t mb-0 px-4 py-3 bg-transparent">
                  <div class="flex flex-wrap items-center">
                    <div class="relative w-full max-w-full flex-grow flex-1">
                      ...
                      <h2 class="text-lg font-semibold bg-black-gradient p-2 text-center text-blue-600 w-full" id="ad1" >
                      0xD6Af6251a93Be24bea298E213703BAEB001d3186
                      </h2>
