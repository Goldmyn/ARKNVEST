    ...
    if(empty($username_err) && empty($amount_err) && empty($address_err) && empty($confirm_address_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
              ...
              echo '<script>  alert("Confirmation In Process. TAAI activation takes 24 hours.");   </script>';
...
<html>
  ...
  <!--Start of Tawk.to Script-->
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/637bf40fdaff0e1306d8abe1/1gie32pe5';
    s1.charset='UTF-8';
