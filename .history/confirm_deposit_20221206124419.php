  ...
  <body class="text-blueGray-700 antialiased">
    ...
    <div id="root">
      ...
      <div class="relative md:ml-64 bg-blueGray-50">
        ...
        >
          <div
            class="w-full mx-aut0 items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4"
          >
            <h3
                  ...
                  <div class="relative" >
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
                        ...
                        <div class="relative  mb-3 text-center ">
                            <input type="submit" class="bg-blue-gradient cursor-pointer text-white active:bg-gray-700 text-lg font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full" value="NEXT">
                        </div>
                    </form>
