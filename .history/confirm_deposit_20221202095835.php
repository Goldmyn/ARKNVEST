                  ...
                  <div class="relative" >
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
                        ...
                        <div class="relative w-full mb-3">
                          ...
                          <select id="network" name="network" class="border-0 px-2 py-2 placeholder-gray-400 text-gray-700 bg-white rounded text-2xl font-bold shadow focus:outline-none focus:ring w-full <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $network; ?>">
