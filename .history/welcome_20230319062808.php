...
<html>
  ...
  <body class="text-blueGray-700 antialiased">
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-black rounded-lg mb-6 xl:mb-0 shadow-lg">
                      <div class="flex-auto p-4">
                        ...
                        if ($_SESSION['portfolio'] > 100) {
                            ...
                            echo '<button id="start-trade-button" onclick="startTrade()">Start Trade</button>';
                        } else {
                            // The session variable data is not above 100, so don't display the start trade button
                            echo '<p>You must have at least 100 data points to start trading.</p>';
                        }
                        ?>
   ...
   <script>
var countdown = 30 * 24 * 60 * 60 * 1000; // 30 days in milliseconds

setTimeout(function() {
    document.getElementById("start-trade-button").disabled = true;
}, countdown);
</script>
