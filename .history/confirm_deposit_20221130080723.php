...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($amount_err) && empty($address_err) && empty($confirm_address_err)){
        ...
        $sql = "INSERT INTO deposit (username, amount, address) VALUES (?, ?, ?)";
    ...
    <div id="root">
      ...
      >
        ...
        >
          ...
          <div
            class="md:flex bg-blue-gradient md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center  flex-1 rounded hidden"
        ...
        <div class="relative bg-pink-600 md:pt-32 pb-32 pt-12">
          <div class="px-4 md:px-10 mx-auto w-full">
            <div class="text-center font-bold text-3xl text-gold-gradient">
              <!-- Card stats --> <span class="text-gradient"> TRADE ACCOUNT ACTIVATION </span>
              <p class="text-white text-xl p-2 font-semibold text-center">
                  Provide the Wallet Address used for deposit.
              </p>
            </div>
          </div>
        </div>
                ...
                <div class="rounded-t mb-0 px-4 py-3 bg-transparent">
                  <div class="flex flex-wrap items-center">
                    <div class="relative w-full max-w-full flex-grow flex-1">
                      ...
                      Paste Your ERC20 or BEP20  Address 
                      </h2>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="relative" >
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
                        ...
                        <div class="relative w-full mb-3">
                            <label class="block uppercase text-white text-center text-xs font-bold mb-2"
                            for="grid-password">
                            Insert Wallet Address To Approve Transactions With</label>
                        ...
                        <div class="relative w-full mb-3">
                            <label class="block uppercase text-white text-center text-xs font-bold mb-2"
                            for="grid-password">
                            Enter Your Account Username</label>
